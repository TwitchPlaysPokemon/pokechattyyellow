BattleTentScript:
	...
	ld hl, BattleTentScriptPointers
	ld a, [wBattleTentCurScript]
	jp CallFunctionInTable

BattleTentTextPointers:
	dw BattleTentGuy
	dw BattleTentMart
	dw BattleTentGuy2
...
.lvloop
	...
	ld d, 50
	callba CalcExperience ; calculate experience for next level and store it at hExperience
	pop hl
	push hl
