...
SSAnneRivalBeforeBattleText:
	TX_MARKOV _SSAnneRivalBeforeBattleText
	db "@"

SSAnneRivalDefeatedText:
	TX_MARKOV _SSAnneRivalDefeatedText
	db "@"

SSAnneRivalWonText:
	TX_MARKOV _SSAnneRivalWonText
	db "@"

SSAnne2Text3:
	TX_MARKOV _SSAnneRivalCaptainText
	db "@"
