...
CinnabarGymText_75ac2:
	TX_MARKOV _CinnabarGymText_75ac2
	db "@"

CinnabarGymText_75ac7:
	TX_MARKOV _CinnabarGymText_75ac7
	db "@"
...
CinnabarGymText_f2169:
	TX_MARKOV _CinnabarGymText_1
	db "@"

CinnabarGymText_f216e:
	TX_MARKOV _CinnabarGymText_2
	db "@"

CinnabarGymText_f2173:
	TX_MARKOV _CinnabarGymText_3
	db "@"

CinnabarGymText_f2178:
	TX_MARKOV _CinnabarGymText_4
	db "@"

CinnabarGymText_f217d:
	TX_MARKOV _CinnabarGymText_5
	db "@"

CinnabarGymText_f2182:
	TX_MARKOV _CinnabarGymText_6
	db "@"

CinnabarGymText_f2187:
	TX_MARKOV _CinnabarGymText_7 ; unused
	db "@"
