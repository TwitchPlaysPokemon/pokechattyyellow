...
UGPathRoute7EntranceUnusedText_5d773:
	TX_MARKOV _UGPathRoute7EntranceUnusedText_5d773
	db "@"

UGPathRoute7EntranceUnusedText_5d778:
	TX_MARKOV _UGPathRoute7EntranceUnusedText_5d778
	db "@"

UGPathRoute7EntranceUnusedText_5d77d:
	TX_MARKOV _UGPathRoute7EntranceUnusedText_5d77d
	db "@"

UGPathRoute7EntranceUnusedText_5d782:
	TX_MARKOV _UGPathRoute7EntranceUnusedText_5d782
	db "@"
