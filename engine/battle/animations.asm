...
PlayAnimation:
	xor a
	ld [hBaseTileID], a ; it looks like nothing reads this
...
SpecialEffectPointers:
	dbw SE_DARK_SCREEN_FLASH, AnimationFlashScreen ; $FE
	dbw SE_DARK_SCREEN_PALETTE, AnimationDarkScreenPalette ; $FD
	dbw SE_RESET_SCREEN_PALETTE, AnimationResetScreenPalette ; $FC
	dbw SE_SHAKE_SCREEN, AnimationShakeScreen ; $FB
	dbw SE_WATER_DROPLETS_EVERYWHERE, AnimationWaterDropletsEverywhere ; $FA
	dbw SE_DARKEN_MON_PALETTE, AnimationDarkenMonPalette ; $F9
	dbw SE_FLASH_SCREEN_LONG, AnimationFlashScreenLong ; $F8
	dbw SE_SLIDE_MON_UP, AnimationSlideMonUp ; $F7
	dbw SE_SLIDE_MON_DOWN, AnimationSlideMonDown ; $F6
	dbw SE_FLASH_MON_PIC, AnimationFlashMonPic ; $F5
	dbw SE_SLIDE_MON_OFF, AnimationSlideMonOff ; $F4
	dbw SE_BLINK_MON, AnimationBlinkMon ; $F3
	dbw SE_MOVE_MON_HORIZONTALLY, AnimationMoveMonHorizontally ; $F2
	dbw SE_RESET_MON_POSITION, AnimationResetMonPosition ; $F1
	dbw SE_LIGHT_SCREEN_PALETTE, AnimationLightScreenPalette ; $F0
	dbw SE_HIDE_MON_PIC, AnimationHideMonPic ; $EF
	dbw SE_SQUISH_MON_PIC, AnimationSquishMonPic ; $EE
	dbw SE_SHOOT_BALLS_UPWARD, AnimationShootBallsUpward ; $ED
	dbw SE_SHOOT_MANY_BALLS_UPWARD, AnimationShootManyBallsUpward ; $EC
	dbw SE_BOUNCE_UP_AND_DOWN, AnimationBoundUpAndDown ; $EB
	dbw SE_MINIMIZE_MON, AnimationMinimizeMon ; $EA
	dbw SE_SLIDE_MON_DOWN_AND_HIDE, AnimationSlideMonDownAndHide ; $E9
	dbw SE_TRANSFORM_MON, AnimationTransformMon ; $E8
	dbw SE_LEAVES_FALLING, AnimationLeavesFalling ; $E7
	dbw SE_PETALS_FALLING, AnimationPetalsFalling ; $E6
	dbw SE_SLIDE_MON_HALF_OFF, AnimationSlideMonHalfOff ; $E5
	dbw SE_SHAKE_ENEMY_HUD, AnimationShakeEnemyHUD ; $E4
	dbw SE_SHAKE_ENEMY_HUD_2, AnimationShakeEnemyHUD ; unused--same pointer as SE_SHAKE_ENEMY_HUD ($E4)
	dbw SE_SPIRAL_BALLS_INWARD, AnimationSpiralBallsInward ; $E2
	dbw SE_DELAY_ANIMATION_10, AnimationDelay10 ; $E1
	dbw SE_FLASH_ENEMY_MON_PIC, AnimationFlashEnemyMonPic ; unused--same as SE_FLASH_MON_PIC ($F5), but for the enemy mon
	dbw SE_HIDE_ENEMY_MON_PIC, AnimationHideEnemyMonPic ; $DF
	dbw SE_BLINK_ENEMY_MON, AnimationBlinkEnemyMon ; $DE
	dbw SE_SHOW_MON_PIC, AnimationShowMonPic ; $DD
	dbw SE_SHOW_ENEMY_MON_PIC, AnimationShowEnemyMonPic ; $DC
	dbw SE_SLIDE_ENEMY_MON_OFF, AnimationSlideEnemyMonOff ; $DB
	dbw SE_SHAKE_BACK_AND_FORTH, AnimationShakeBackAndForth ; $DA
	dbw SE_SUBSTITUTE_MON, AnimationSubstitute ; $D9
	dbw SE_WAVY_SCREEN, AnimationWavyScreen ; $D8
	db $FF
