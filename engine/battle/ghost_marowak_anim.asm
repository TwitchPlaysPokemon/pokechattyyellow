...
; now that the ghost pic is being displayed using sprites, clear the ghost pic from the BG tilemap
	...
	call Delay3
	xor a
	ld [hBGMapMode], a ; disable BG transfer so we don't see the Marowak too soon
...
.fadeInMarowakLoop
	...
	ld a, $1
	ld [hBGMapMode], a ; enable BG transfer so the BG Marowak pic will be visible after the sprite one is cleared
	call Delay3
	jp ClearSprites
