...
; zero the animation counters
	xor a
	ld [wPlayerIntraAnimFrameCounter], a
	ld [wPlayerAnimFrameCounter], a
...
.moving
	...
	call AdvanceSpriteMovementFrameCounters
	call .updatePlayerSpriteImage
.skipSpriteAnim
...
UpdateNPCSprite:
	...
	cp $4
	jp z, UpdateSpriteMovementStatus
	ld a, [wWalkCounter]
	and a
	...
	ld a, [hCurrentSpriteOffset]
	add wSprite01MovementByte1 - wSprite01SpriteStateData2
	ld l, a
...
.noNextAnimationFrame
	ld a, [hCurrentSpriteOffset]
	add wSprite01YStepVector - wSprite01SpriteStateData1
	ld l, a
	...
	ret nz
	ld a, wSprite01MovementByte1 - wSprite01SpriteStateData2 ; walking finished, update state
	add l
	ld l, a
	ld a, [hl]                       ; c2x6 (movement byte 1)
	cp WALK
...
.initNextMovementCounter
	call Random
	ld a, [hCurrentSpriteOffset]
	add wSprite01MovementDelay - wSprite01SpriteStateData2
	ld l, a
	ld a, [hRandomAdd]
	and $7f
...
notYetMoving:
	ld h, wSpriteStateData1 / $100
	ld a, [hCurrentSpriteOffset]
	add wSprite01AnimFrameCounter - wSprite01SpriteStateData1
	ld l, a
...
.facingDirectionDetermined
	ld a, [hCurrentSpriteOffset]
	add wSprite01FacingDirection - wSprite01SpriteStateData1
	ld l, a
...
InitializeSpriteStatus:
	...
	inc h
	ld a, [hCurrentSpriteOffset]
	add wSprite01YDisplacement - wSprite01SpriteStateData2
	ld l, a
	ld a, $8
...
InitializeSpriteScreenPosition:
	ld h, wSpriteStateData2 / $100
	ld a, [hCurrentSpriteOffset]
	add wSprite01MapY - wSprite01SpriteStateData2
	ld l, a
	ld a, [wYCoord]
	ld b, a
...
.spriteInvisible
	ld h, wSpriteStateData1 / $100
	ld a, [hCurrentSpriteOffset]
	add wSprite01SpriteImageIdx - wSprite01SpriteStateData1
	ld l, a
	ld [hl], $ff       ; c1x2
	scf
	jr .done
...
.spriteVisible
	...
	inc h
	ld a, [hCurrentSpriteOffset]
	add wSprite01GrassPriority - wSprite01SpriteStateData2
	ld l, a
	ld a, [wGrassTile]
	cp c
	ld a, $0
...
UpdateSpriteImage:
	...
	add b
	ld b, a
	ld a, [hTilePlayerStandingOn]  ; current sprite offset
	add b
	ld b, a
	ld a, [hCurrentSpriteOffset]
	add wSprite01SpriteImageIdx - wSprite01SpriteStateData1
...
.notScripted
	...
	ld h, wSpriteStateData1 / $100
	ld a, [hCurrentSpriteOffset]
	add wSprite01YPixels - wSprite01SpriteStateData1
	ld l, a
...
GetSpriteScreenYPointer:
	ld a, wSprite01YPixels - wSprite01SpriteStateData1
	ld b, a
	jr GetSpriteScreenXYPointerCommon

GetSpriteScreenXPointer:
	ld a, wSprite01XPixels - wSprite01SpriteStateData1
	ld b, a
...
AnimScriptedNPCMovement:
	...
	ld a, [hCurrentSpriteOffset]
	add wSprite01SpriteImageBaseOffset - wSprite01SpriteStateData2
	ld l, a
	ld a, [hl] ; VRAM slot
	dec a
	swap a
...
AdvanceSpriteMovementFrameCounters:
	ld a, [hCurrentSpriteOffset]
	add wSprite01IntraAnimFrameCounter - wSprite01SpriteStateData1
	ld l, a
	ld h, wSpriteStateData1 / $100
...
.asm_52e6
	...
	ld a, [hCurrentSpriteOffset]
	ld l, a
	ld [hl], $8 ; wSprite0xWalkAnimationCounter
	dec h
	inc l
	ld [hl], $4 ; wSprite0xMovementStatus
	call UpdateSpriteImage
	scf
	ret
...
.asm_52fa
	call LoadStepVector
	; h should be $c2 here, but isn't
	; this results in buggy behavior
	ld a, [hCurrentSpriteOffset]
	ld l, a
	ld [hl], $8 ; wSprite0xPictureID
	dec h
	inc l
	ld [hl], $3 ; c0x1 (music RAM)
	call UpdateSpriteImage
	scf
	ret
...
.asm_530b
	...
	dec h
	inc l
	ld [hl], $3 ; wSprite0xMovementStatus
	call UpdateSpriteImage
	scf
	ret
...
UpdateSpriteMovementStatus:
	...
	dec [hl]
	ret nz
	ld a, wSprite01MovementByte1 - wSprite01SpriteStateData2
	add l
	ld l, a
	ld a, [hl]
	cp WALK
