_GetSpritePosition1:
	...
	ld de, wSprite01YPixels - wSprite01SpriteStateData1
	ld a, [wSpriteIndex]
	...
	ld de, wSprite01MapY - wSprite01XPixels
	add hl, de
...
_SetSpritePosition1:
	...
	ld [hSpriteIndexOrTextID], a
	call GetSpriteDataPointer
	ld a, [hCurSpriteScreenY] ; c1x4 (screen Y pos)
	ld [hli], a
	inc hl
	ld a, [hCurSpriteScreenX] ; c1x6 (screen X pos)
	ld [hl], a
	ld de, wSprite01MapY - wSprite01XPixels
	add hl, de
	ld a, [hCurSpriteMapY] ; c2x4 (map Y pos)
	ld [hli], a
	ld a, [hCurSpriteMapX] ; c2x5 (map X pos)
	ld [hl], a
	ret
...
.linedUpY
	...
	call SubtractSigned  ; calc distance
