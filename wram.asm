...
wSurfingMinigameRoutineNumber:: ; c5d1
	ds 1
wSurfingMinigamePikachuObjectFunctionIndex:: ; c5d2
	ds 1
...
wSurfingMinigameTrickFlags:: ; c62f
	ds 1
wSurfingMinigameFailed:: ; c630
	ds 1
wSurfingMinigameFailureScreenTimer:: ; c631
	ds 1
...
wSurfingMinigameUpdateMusicTempo:: ; c634
	ds 1
...
wd472:: ds 1 ; d471
; bit 6: Pikachu knows Surf
; bit 7: Pikachu belongs to Player
wd473:: ds 1 ; d472
...
wd492:: ds 1 ; d492
	; bit 1: can quit minigame by pressing select
	ds 1
