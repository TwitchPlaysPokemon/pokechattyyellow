	const_def
	const SET_PAL_BATTLE_BLACK
	const SET_PAL_BATTLE
	const SET_PAL_TOWN_MAP
	const SET_PAL_STATUS_SCREEN
	const SET_PAL_POKEDEX
	const SET_PAL_SLOTS
	const SET_PAL_TITLE_SCREEN
	const SET_PAL_NIDORINO_INTRO
	const SET_PAL_GENERIC
	const SET_PAL_OVERWORLD
	const SET_PAL_PARTY_MENU
	const SET_PAL_POKEMON_WHOLE_SCREEN
	const SET_PAL_GAME_FREAK_INTRO
	const SET_PAL_TRAINER_CARD
	const SET_PAL_SURFING_PIKACHU
	const SET_PAL_SURFING_PIKACHU_INTRO
